...
import { ChefTarifsCreerForm } from "./ChefTarifsCreerPage";
  ...
  return (
    <div style={st.page}>
      <main style={st.main}>
        ...
        <Modal open={modalOpen} title="Nouveau tarif" onClose={() => setModalOpen(false)}>
          <ChefTarifsCreerForm
...
const st = {
  ...
  btnAdd:    { padding: "10px 20px", fontSize: "14px", fontWeight: "700", color: "#fff", backgroundColor: "#26C2A1", border: "none", borderRadius: "8px", cursor: "pointer" },
  ...
  inputPrix: { width: "90px", padding: "3px 8px", fontSize: "13px", borderRadius: "4px", border: "1px solid #E5E7EB", color: "#1A1348", outline: "none", fontFamily: "inherit" },
