        ...
        {onglet === "trajets" && (
          <>
            <div style={st.statsRow}>
              ...
              <StatChip label="Recettes totales"  value={`${totalRecettesTrajets.toLocaleString("fr-FR")} XOF`}  color="#56D364" small />
            </div>
            <div style={st.card}>
                  ...
                  <table style={st.table}>
                    ...
                    <tbody>
                      {trajets.map(t => {
                        ...
                        const tauxColor = taux >= 80 ? "#56D364" : taux >= 50 ? "#F0883E" : "#6E7681";
                        return (
                          <tr key={t.id} style={st.tr}>
                            ...
                            <td style={st.td}>
                              <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                                <div style={{ width: "48px", height: "5px", backgroundColor: "#21262D", borderRadius: "3px", overflow: "hidden" }}>
                            ...
                            <td style={st.td}>
                              <span style={{ fontWeight: "700", color: "#56D364" }}>
                                {t.recettes.toLocaleString("fr-FR")} <span style={{ color: "#6E7681", fontSize: "11px" }}>XOF</span>
                              </span>
                            </td>
                            <td style={st.td}>
        ...
        {onglet === "billets" && (
          <>
            <div style={st.statsRow}>
              ...
              <StatChip label="Recettes encaissées" value={`${totalRecettes.toLocaleString("fr-FR")} XOF`} color="#56D364" small />
            </div>
            <div style={st.card}>
                        ...
                        return (
                          <tr key={b.id} style={st.tr}>
                            ...
                            <td style={st.td}>
                              ...
                              {b.passager_telephone && <span style={{ fontSize: "11px", color: "#6E7681" }}>{b.passager_telephone}</span>}
                            </td>
                            <td style={st.td}>
...
const st = {
  ...
  toolbar:    { display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "12px", borderBottom: "1px solid #21262D", paddingBottom: "0" },
  tabs:       { display: "flex", gap: "4px" },
  tab:        { padding: "10px 22px", fontSize: "14px", fontWeight: "600", color: "#8B949E", backgroundColor: "transparent", border: "none", borderBottom: "2px solid transparent", cursor: "pointer", fontFamily: "inherit", marginBottom: "-1px" },
  tabActif:   { color: "#E6EDF3", borderBottomColor: "#58A6FF" },
  selectJours:{ padding: "7px 12px", backgroundColor: "#161B22", border: "1px solid #30363D", borderRadius: "8px", color: "#E6EDF3", fontSize: "13px", fontFamily: "inherit", cursor: "pointer", marginBottom: "1px" },
